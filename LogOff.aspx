<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogOff.aspx.cs" Inherits="MarriottLearningGuides.LogOff" %>
...
<body bgcolor="#e6e4e5">
    <div id="main" class="externalMainDiv">
        ...
        <div id="message" class="externalMessage">
            <b>Thank you for using the Learning Guide. &nbsp;Please close your browser now to complete your logout and close your session.</b>
        </div>
