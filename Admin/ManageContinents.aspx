<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManageContinents.aspx.cs" Inherits="MarriottLearningGuides.Admin.ManageContinents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width:954px; padding-bottom: 30px;">
        <div class="PageHeader">
            ...
            <img src="../sysimages/earth.png" width="24" height="24" alt="Manage" />
        ...
        <div style="margin-top:22px;">
            ...
            <div align="right" style="padding-bottom:12px;">
                <asp:Button ID="btnAddNew" runat="server" Text="Add New Continent" OnCommand="SetupAddEdit_Command" CommandName="SetupAddItem" />
            </div>
            ...
            <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" IconUrl="../sysimages/earth_16x16.png">
                <Windows>
                    <telerik:RadWindow ID="rwAddEdit" runat="server" Title="Add Continent"
                        ...
                        <ContentTemplate>
                            ...
                            <table id="Table1" cellspacing="1" cellpadding="3" width="456" border="0" style="margin-left:20px; margin-top: 12px;">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <telerik:RadTextBox ID="txtName" Width="360px" runat="server" MaxLength="50"></telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size:12px;">
