<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManageInformalCourseHeaders.aspx.cs" Inherits="MarriottLearningGuides.Admin.ManageInformalCourseHeaders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width:954px; padding-bottom: 30px;">
        <div class="PageHeader">
            ...
            <img src="../sysimages/books.png" width="24" height="24" alt="Manage" />
            <div style="margin-left: 30px; margin-top: -27px;">
                Manage Informal Course Headers
            </div>
        ...
        <asp:Literal ID="ValidationMessage" runat="server"></asp:Literal>
            ...
            <div align="right" style="padding-bottom:12px;">
                <asp:Button ID="btnAddNew" runat="server" Text="Add New Course Header" OnCommand="SetupAddEdit_Command" CommandName="SetupAddItem" />
            </div>
            ...
            <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" IconUrl="../sysimages/books_16x16.png">
                <Windows>
                    <telerik:RadWindow ID="rwAddEdit" runat="server" Title="Add Course Header" Height="186px"
                        ...
                        <ContentTemplate>
                            ...
                            <table id="Table1" cellspacing="1" cellpadding="3" width="456" border="0" style="margin-left:20px; margin-top: 12px;">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <telerik:RadTextBox Width="360px" ID="txtName" runat="server" MaxLength="500"></telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size:12px;">
