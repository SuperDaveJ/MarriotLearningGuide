<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManageCompetencies.aspx.cs" Inherits="MarriottLearningGuides.Admin.ManageCompetencies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width:954px; padding-bottom: 30px;">
        <div class="PageHeader">
            ...
            <img src="../sysimages/signpost.png" width="24" height="24" alt="Manage" />
        ...
        <div style="margin-top:22px;">
            ...
            <div align="right" style="padding-bottom:12px;">
                <asp:Button ID="btnAddNew" runat="server" Text="Add New Competency" OnCommand="SetupAddEdit_Command" CommandName="SetupAddItem" />
            </div>
            <telerik:RadGrid ID="rgMain" runat="server" OnHTMLExporting="rgMain_HTMLExporting" OnGridExporting="rgMain_GridExporting" OnItemCommand="rgMain_ItemCommand" OnPageSizeChanged="rgMain_PageSizeChanged" PageSize="50" OnNeedDataSource="rgMain_NeedDataSource">
                ...
                <MasterTableView DataKeyNames="ID">
                    <Columns>
                        <telerik:GridBoundColumn  HeaderStyle-Width="80%" ItemStyle-HorizontalAlign="Left" UniqueName="Name" HeaderText="Name" DataField="Name" HeaderStyle-HorizontalAlign="Left">
            ...
            <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" IconUrl="../sysimages/signpost_16x16.png">
                <Windows>
                    <telerik:RadWindow ID="rwAddEdit" runat="server" Title="Add Competency"
                        Width="490px" Left="150px" ReloadOnShow="true" ShowContentDuringLoad="false"
                        Modal="true"  Behaviors="Close" VisibleStatusbar="false">
                        <ContentTemplate>
                            <asp:HiddenField ID="hdnID" runat="server" />
                            <table id="Table1" cellspacing="1" cellpadding="3" width="426" border="0" style="margin-left:20px; margin-top: 12px;">
                               <tr>
                                    <td colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <telerik:RadTextBox Width="360px" ID="txtName" runat="server" MaxLength="50"></telerik:RadTextBox>
                                    </td>
                                </tr>
                            </table>
                            <table width="428" style="margin-top: 14px;">
                                <tr>
