<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManagePositionTypes.aspx.cs" Inherits="MarriottLearningGuides.Admin.ManagePositionTypes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width:954px; padding-bottom: 30px;">
        <div class="PageHeader">
            ...
            <img src="../sysimages/id_card.png" width="24" height="24" alt="Manage" />
        ...
        <div style="margin-top:22px;">
            ...
            <div align="right" style="padding-bottom:12px;">
                <asp:Button ID="btnAddNew" runat="server" Text="Add New Position Type" OnCommand="SetupAddEdit_Command" CommandName="SetupAddItem" />
            </div>
            ...
            <telerik:RadWindowManager ID="RadWindowManager1" runat="server" EnableShadow="true" IconUrl="../sysimages/id_card_16x16.png">
                <Windows>
                    <telerik:RadWindow ID="rwAddEdit" runat="server" Title="Add Position Type"
